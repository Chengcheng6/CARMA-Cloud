...
!  define physics buffer indicies here       
  integer :: &
    ...
    cmeice_idx, &       ! cmeice_idx index in physics buffer
...
!-------------------------------------------------------------------------------
    ...
    call pbuf_add_field('CMEICE',     'physpkg',dtype_r8, (/pcols,pver/),                  cmeice_idx)
...
!-------------------------------------------------------------------------------
    ...
    !++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	! LW (Apr 2023): added for disabling CLUBB to transport the CARMA liq bins    
    integer :: ibin                                         ! CARMA bin number
    integer :: ixCRLIQbin                                   ! index for CRLIQxx
    character(len=2) :: CARMAbinNumber 
	!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    
    ...
    ! LW (Apr 2023): added for disabling CLUBB to transport the CARMA liq bins    
    do ibin = 1, 48 
       write(CARMAbinNumber, '(I2.2)') ibin
       call cnst_get_ind('CRLIQ'//CARMAbinNumber, ixCRLIQbin)
...
!-------------------------------------------------------------------------------
   ...
   real(r8), pointer, dimension(:,:) :: cmeice 
