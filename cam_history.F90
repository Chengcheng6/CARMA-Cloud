...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !
  !integer, parameter :: tbl_hash_oflow_percent = 20     !+++ Cheng: May also test changing here     
  integer, parameter :: tbl_hash_oflow_percent = 21     !+++ Cheng: May also test changing here   ! ...  
  !
...
9004 format('---------------------------------------')
  ...
  subroutine bld_outfld_hash_tbls()
    ...
    !+++ Cheng: debug   !see original ERROR here    !(tested_v1: can't just comment out) 
