  ...
  subroutine CARMA_CloudFraction(carma, cstate, cam_in, state, icol, cldfrc, cldfrci, cldfrcl, rhcrit, rc)
    ...
    real(r8)                :: cldfrci(pver)     !! ice cloud fraction
    real(r8)                :: cldfrcl(pver)    
