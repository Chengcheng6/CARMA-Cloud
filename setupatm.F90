...
subroutine setupatm(carma, cstate, rescale, rc)
  ...
  logical, intent(in)                  :: rescale     !! rescale the fall velocity for zmet change, this is instead of recalculating
  ...
  if ( do_vtran .or. do_coag .or. do_grow .or. do_drydep ) then
  ...
  ! JAS, this is the condition for allocating vf and dkz in carmastate_mod
