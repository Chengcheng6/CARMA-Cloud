...
#define qsatfac       cstate%f_qsatfac
#define prain         cstate%f_prain
#define nevapr        cstate%f_nevapr
...
#define actpe         cstate%f_actpe
#define clubb_kvh     cstate%f_clubb_kvh

#define immersebccb cstate%f_immersebccb
#define immersed1cb cstate%f_immersed1cb
#define immersed2cb cstate%f_immersed2cb
#define immersebcit cstate%f_immersebcit
#define immersed1it cstate%f_immersed1it
#define immersed2it cstate%f_immersed2it
#define awcambc cstate%f_awcambc
#define awcamd1 cstate%f_awcamd1
#define awcamd2 cstate%f_awcamd2
#define awfacmbc cstate%f_awfacmbc
#define awfacmd1 cstate%f_awfacmd1
#define awfacmd2 cstate%f_awfacmd2
#define lcldm cstate%f_lcldm
#define hetrbc cstate%f_hetrbc
#define hetrd1 cstate%f_hetrd1
#define hetrd2 cstate%f_hetrd2

! Nucleation trackers added by CMALONEY
#define pc_so4        cstate%f_pc_so4
#define pc_dst        cstate%f_pc_dst
